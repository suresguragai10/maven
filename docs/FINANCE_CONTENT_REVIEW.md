...
| File/field | Current value | Sensitive because | Primary source recorded? | Verification needed | Recommended action |
|---|---|---|---|---|---|
| Team-profile qualification claims in `content/site.yaml` | Current published bios include specific qualification/certification wording, including CA/Chartered Accountant, ACCA membership, semi-qualified CA status and an ISO/IEC 27001:2022 ISMS Auditor/Lead Auditor certification. | Professional-qualification wording is trust-sensitive and should not be inferred from role titles or marketing copy. | The claims come from the owner-supplied Team content; this review does not independently verify professional registers or certificates. | **Owner verification required**: retain supporting records and confirm names/designations remain current before publishing future edits. | **Keep only as supplied and verified by the owner.** The 2026-09-22 Team premium pass changed presentation, not the underlying credential claims. |
